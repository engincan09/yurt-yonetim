...
namespace YurtYonetim.Dal.Middleware
{
    /// <summary>
    ...
    public static class HostingEnvironmentExtensions
    {
        ...
        /// <summary>
        /// Raporların tutulduğu klasör yoludur.
        /// </summary>
        /// <param name="env"></param>
        /// <returns></returns>
        public static string ContentReportPath(this IHostingEnvironment env) => Path.Combine(env.ContentRootPath(), "reports");
        ...
        public static void CreateContentFolders(this IHostingEnvironment env)
        {
            ...
            if (!Directory.Exists(env.ContentReportPath()))
            {
                Directory.CreateDirectory(env.ContentReportPath());
            }
        }
    }
}